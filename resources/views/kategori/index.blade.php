...
@section('content')
@if ($kategori === "Ruang Makan")
    <!--================Home Banner Area =================-->
    <!-- breadcrumb start-->
    <div>
    <section class="breadcrumb breadcrumb_bg_dining">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item">
                            <h2>Ruang Makan</h2>
                            <b><p>Home <span>-</span> Shop <span>-</span>Ruang Makan</p><b>
                        </div>
                    </div>
                </div>
            </div>
...
@elseif ($kategori === "Ruang Kerja")
    ...
    <!-- breadcrumb start-->
    <div>
    <section class="breadcrumb breadcrumb_bg_work">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item">
                            <h2>Ruang Kerja</h2>
                            <b><p>Home <span>-</span> Shop <span>-</span>Ruang Kerja</p><b>
                        </div>
                    </div>
                </div>
            </div>
