...
@section('content')
    ...
    <!-- breadcrumb start-->
    <div>
    <section class="breadcrumb breadcrumb_bg_decor">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item">
                            <h2>Dekorasi</h2>
                            <b><p>Home <span>-</span> Shop <span>-</span>Dekorasi</p><b>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row align-items-center latest_product_inner">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_product_item">
                                <img src="img/product/karpet.jpg" alt="">
                                <div class="single_product_text">
                                    <h4>Karpet</h4>
                                    <h3>IDR 100.000</h3>
                                    <a href="#" class="add_cart">+ tambah ke keranjang<i class="ti-heart"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_product_item">
                                <img src="img/product/dekor-1.jpg" alt="">
                                <div class="single_product_text">
                                    <h4>Hiasan</h4>
                                    <h3>IDR 100.000</h3>
                                    <a href="#" class="add_cart">+ tambah ke keranjang<i class="ti-heart"></i></a>
